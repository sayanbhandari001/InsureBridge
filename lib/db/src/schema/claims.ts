...
export const claimsTable = pgTable("claims", {
  ...
  hospitalDiscount: numeric("hospital_discount", { precision: 12, scale: 2 }),
  paidByCustomer: numeric("paid_by_customer", { precision: 12, scale: 2 }),
  paidByInsurer: numeric("paid_by_insurer", { precision: 12, scale: 2 }),
