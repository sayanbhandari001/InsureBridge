  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-display font-bold text-foreground">Policy Members</h1>
          <p className="text-muted-foreground mt-1">Manage all insured members and their coverage details.</p>
        </div>
            ...
            <CardContent className="p-5">
              ...
              <div className="space-y-1.5 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-mono text-xs text-muted-foreground">{member.policyNumber}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">DOB</span>
                  <span className="text-muted-foreground">{formatDate(member.dateOfBirth)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Gender</span>
                  <span className="capitalize text-muted-foreground">{member.gender}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Sum Insured</span>
                  <span className="font-semibold text-foreground">{formatCurrency(member.sumInsured)}</span>
                </div>
              </div>
